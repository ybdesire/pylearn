...
import androguard.core.api_specific_resources.aosp_permissions.aosp_permissions_api23 as api23
...
AOSP_PERMISSIONS = {
	...
	"23": {"AOSP_PERMISSIONS" : api23.AOSP_PERMISSIONS, "AOSP_PERMISSIONS_GROUPS": api23.AOSP_PERMISSION_GROUPS},
}
